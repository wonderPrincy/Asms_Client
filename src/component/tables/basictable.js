...
function Basictable(props) {
  return (
    <Fragment>
      <Breadcrumb parent="Tables / Bootstrap Tables" title="Basic Tables" />
          ...
          <Col sm="12">
            <Card>
              <CardHeader>
                ...
                <span>
                  {" "}
                  Use a class <code> table-inverse </code> inside table element.
                </span>
              </CardHeader>
              <div className="table-responsive">
              ...
              <CardHeader>
                ...
                <span>
                  ...
                  <span className="d-block">
                    {" "}
                    To set the light background color use .bg-[color] class
                    where [color] is the value of your selected color from stack
                    color palette. So for teal color background class will be
                    .bg-teal{" "}
                  </span>
                </span>
              </CardHeader>
          ...
          <Col sm="12">
            <Card>
              <CardHeader>
                ...
                <span>
                  Use a class <code> table-hover </code> to enable a hover state
            ...
            <Card>
              <CardHeader>
                ...
                <span>
                  ...
                  cells. you may use Classes <code>table-primary</code>,
                  <code>table-secondary</code>,<code>table-success</code>,
                  <code>table-info</code>,<code>table-warning</code>,
                  <code>table-danger</code>,<code>table-light</code>,
                  <code>table-active</code> in<code>tr</code>
                </span>
              </CardHeader>
              <div className="table-responsive">
                <Table>
            ...
            <Card>
              <CardHeader>
                ...
                <span>
                  ...
                  inverse table, however, you may use Classes{" "}
                  <code>bg-dark</code>,<code>bg-warning</code>,
                  <code>bg-success</code>,<code>bg-info</code>,
                  <code>bg-danger</code>,<code>bg-primary</code>,
                  <code>bg-secondary</code>,<code>bg-light</code> in
                  <code>td</code>
                </span>
              </CardHeader>
              <div className="table-responsive">
            ...
            <Card>
              <CardHeader>
                ...
                <span>
                  ...
                  <code>.thead-dark</code> to make <code>thead</code> appear
                  light or dark gray.
                </span>
              </CardHeader>
          ...
          <Col sm="12">
            <Card>
              <CardHeader>
                ...
                <span>
                  Similar to tables and dark tables, use the modifier classes{" "}
                  <code>.bg-*</code>and <code>.thead-light</code> to make{" "}
                  <code>thead</code> appear light or dark gray.
                </span>
              </CardHeader>
              <div className="card-block row">
                <Col sm="12" lg="12" xl="12">
            ...
            <Card>
              <CardHeader>
                ...
                <span>
                  ...
                  table row within the <code></code>. This styling doesn't work
                  in IE8 and below as :nth-child CSS selector isn't supported.
                </span>
              </CardHeader>
              <div className="card-block row">
                <Col sm="12" lg="12" xl="12">
