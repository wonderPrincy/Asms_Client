...
import {
  ...
  updateTask,
  markAllTask,
} from "../../../redux/service/todo-firebase-service";
...
const TodoFirebase = () => {
  ...
  return (
    <Fragment>
      <Breadcrumb parent="Apps / User" title="To-Do Firebase" />
      <Container fluid={true}>
        <Row>
          <Col xl="12">
            <Card>
              <CardHeader>
                <h5>To-Do Firebase</h5>
              </CardHeader>
              <CardBody>
                <div className="todo">
                                  ...
                                  <div className="task-container">
                                    ...
                                    <span className="task-action-btn">
                                      ...
                                      <span
                                        ...
                                        title="Mark Complete"
                                        onClick={() =>
                                          handleMarkedTodo(index, todoData)
                                        }
                                      >
                                        <i className="icon">
                                          <i className="icon-check"></i>
