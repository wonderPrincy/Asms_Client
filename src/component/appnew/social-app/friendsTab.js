      ...
      <Row>
        <Col md="6 xl-50 box-col-6" xl="4">
          <Card className="custom-card">
            <CardHeader>
              <Media body className="img-fluid" src={one} alt="" />
            </CardHeader>
            <div className="card-profile">
              <Media body className="rounded-circle" src={three} alt="" />
            </div>
        ...
        <Col md="6 xl-50 box-col-6" xl="4">
          <Card className="custom-card">
            <CardHeader>
              <Media body className="img-fluid" src={two} alt="" />
            </CardHeader>
            <div className="card-profile">
              <Media body className="rounded-circle" src={sixteen} alt="" />
            </div>
            <ul className="card-social">
              <li>
                <a href="#javascript">
        ...
        <Col md="6 xl-50 box-col-6" xl="4">
          <Card className="custom-card">
            <CardHeader>
              <Media body className="img-fluid" src={four} alt="" />
            </CardHeader>
            <div className="card-profile">
              <Media body className="rounded-circle" src={eleven} alt="" />
            </div>
            <ul className="card-social">
              <li>
                <a href="#javascript">
        ...
        <Col md="6 xl-50 box-col-6" xl="4">
          <Card className="custom-card">
            <CardHeader>
              <Media body className="img-fluid" src={seven} alt="" />
            </CardHeader>
            <div className="card-profile">
              <Media body className="rounded-circle" src={sixteen} alt="" />
            </div>
        ...
        <Col md="6 xl-50 box-col-6" xl="4">
          <Card className="custom-card">
            <CardHeader>
              <Media body className="img-fluid" src={five} alt="" />
            </CardHeader>
            <div className="card-profile">
              <Media body className="rounded-circle" src={eleven} alt="" />
            </div>
        ...
        <Col md="6 xl-50 box-col-6" xl="4">
          <Card className="custom-card">
            <CardHeader>
              <Media body className="img-fluid" src={six} alt="" />
            </CardHeader>
            <div className="card-profile">
              <Media body className="rounded-circle" src={three} alt="" />
            </div>
