        ...
        <CardHeader className="bg-primary">
          <h5 className="mb-0">
            <Accordion.Toggle
              ...
              eventKey="0"
            >
              <i className="icofont icofont-briefcase-alt-2"></i>Collapsible
              Group Item #<span className="digits">1</span>
            </Accordion.Toggle>
          </h5>
        </CardHeader>
        <Accordion.Collapse eventKey="0">
        ...
        <CardHeader className="bg-primary">
          <h5 className="mb-0">
            <Accordion.Toggle
              ...
              eventKey="1"
            >
              <i className="icofont icofont-support"></i>Collapsible Group Item
        ...
        <CardHeader className="bg-primary">
          <h5 className="mb-0">
            <Accordion.Toggle
              ...
              eventKey="2"
            >
              <i className="icofont icofont-tasks-alt"></i>Collapsible Group
              Item #<span className="digits">3</span>
            </Accordion.Toggle>
          </h5>
        </CardHeader>
        <Accordion.Collapse eventKey="2">
