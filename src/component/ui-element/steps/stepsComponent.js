...
export const DefaultStep = (props) => {
  return (
    <Row className="u-steps row">
      <Col xl="4" lg="12" md="4" className="u-step xl-100">
      ...
      <Col xl="4" lg="12" md="4" className="u-step current xl-100">
...
export const StepStates = (props) => {
  return (
    <Row className="row-lg">
      ...
      <Col xl="3" lg="6" className="steps-md-mt xl-50">
      ...
      <Col xl="3" lg="6" className="lg-mt xl-50">
