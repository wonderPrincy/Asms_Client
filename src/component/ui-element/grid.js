        ...
        <Row>
          <Col sm="12">
            <Card>
              <CardHeader>
                <h5>Grid Options</h5>
                <span>
                  Bootstrap grid allows building an equal height flexbile blocks
                  easily
                </span>
              </CardHeader>
              <CardBody>
          ...
          <Col sm="12">
            <Card>
              ...
              <CardBody className="grid-showcase">
                <p>
                  Using a single set of <code>.col-md-*</code> grid classes, you
                  can create a basic grid system that starts out stacked on
                  mobile devices and tablet devices (the extra small to small
                  range) before becoming horizontal on desktop (medium) devices.
                  Place grid columns within any <code>.row</code>.
                </p>
                <Row>
          ...
          <Col sm="12">
            <Card>
              ...
              <CardBody className="grid-showcase">
                <p>
                  Use <code>.order-</code> classNamees for controlling the{" "}
                  <strong>visual order</strong> of your content. These
                  classNamees are responsive, so you can set the{" "}
                  <code>order</code> by breakpoint (e.g.,{" "}
                  <code>.order-1.order-md-2</code>). Includes support for{" "}
                  <code>1</code> through <code>12</code> across all five grid
                  tiers.
                </p>
                <Row>
                  <Col className="col">
            ...
            <Card>
              ...
              <CardBody className="grid-showcase">
                <p>
                  ...
                  <code>*</code> columns. For example, <code>.offset-md-4</code>{" "}
                ...
                <Row>
                  ...
                  <Col sm="4 offset-sm-2" md="6 offset-md-0">
