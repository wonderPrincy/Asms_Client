          ...
          <ul className="nav-menus">
            ...
            <li className="onhover-dropdown">
              ...
              <ul className="onhover-show-div notification-dropdown">
                ...
                <li>
                  <div className="media">
                    <div className="notification-icons bg-success mr-3">
                ...
                <li className="pt-0">
                  <div className="media">
                    <div className="notification-icons bg-info mr-3">
            ...
            <li>
              ...
              >
                <img
                  className="img-fluid img-shadow-success"
                  src={require("../../../assets/images/dashboard/chat.png")}
                  alt=""
                />
              </a>
            </li>
