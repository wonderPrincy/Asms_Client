...
const Product = (props) => {
  ...
  const addWishList = (product) => {
    ...
    history.push(`${process.env.PUBLIC_URL}/ecommerce-app/wishlist`);
  };
                            ...
                            <div className="product-img">
                              ...
                              <div className="product-hover">
                                <ul>
                                  ...
                                  <li>
                                    <i
                                      className="icofont icofont-law-alt-2"
                      ...
                      <Col md="6" className="product-details  text-left">
                        ...
                        <div className="product-qnty">
                          ...
                          <div className="addcart-btn">
                            <Link
                              to={`${process.env.PUBLIC_URL}/ecommerce-app/cart`}
                            >
                              <Button
                                color="primary"
                                className="mr-2 mt-2"
                            ...
                            <Link
                              to={`${process.env.PUBLIC_URL}/ecommerce-app/product-page`}
                            >
                              <Button color="primary" className="mr-2 mt-2">
                                View Details
                              </Button>
                            </Link>
                          </div>
